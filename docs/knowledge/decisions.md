...
| ID | 判断 | 状態 | 根拠 |
|---|---|---|---|
| ADR-001 | 独自主体モデルを使う | partially superseded | 名称オマージュ境界はADR-011へ更新 |
...
| ADR-006 | scenario / experiment / run manifest / result cardを分離する | accepted | result cardと複数seed感度を機械可読出力へ実装 |
