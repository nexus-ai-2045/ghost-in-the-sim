...
| ai-replica-mvp | 3方式・AI判断replayの実装契約 | `docs/architecture/ai-replica-mvp.md` | implemented | 3方式・seed 42を実装済み |
...
| results-template | 実験結果の記録枠 | `RESULTS.md` | measured | seed 42・契約指標を実測。複数seedは未実施 |
