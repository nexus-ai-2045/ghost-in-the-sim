...
const delivered = contract.project({ ...event, partner_action: "observe" }, "到達");
assert.equal(delivered.dialogue[2].speaker, "証拠検証AI", "reservation must retain its recorded actor");
assert.equal(delivered.dialogue[2].role, "到達した留保");
